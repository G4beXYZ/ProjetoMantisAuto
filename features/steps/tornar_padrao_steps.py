...
@given(u'que um perfil ja tenha sido criado')
...
@given(u'esteja na aba "Perfis"')
def step_impl(context):
    accountPage.Perfis()


@given(u'o perfil criado do usuário esteja selecionado')
def step_impl(context):
    accountPage.selecionar_perfil()


@then(u'o perfil criado se tornara padrão')
def step_impl(context):
    accountPage.tornar_padrao()